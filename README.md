...
Pada bagian ini admin dapat melihat daftar restoran yang terdapat pada program _Restaurant Online_ yang sudah ditambahkan sebelumnya
...
Setelah melakukan penambahan atau mengurangi restoran, admin dapat kembali ke halamat _login_ awal
...
Sama seperti _login_ sebagai admin, pada halaman login sebagai pembeli juga memerlukan _password_ sebelum bisa menggunakan menu-menu yang tersedia
...
Pada bagian ini, _user_ perlu mengisi beberapa detail agar dapat melakukan pemesanan makanan melalui resto yang tersedia.
...
Setelah melakukan pemesanan, pembeli dapat kembali ke halamat _login_ awal
